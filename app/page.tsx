      ...
      <section className="bg-white text-gray-800 min-h-[50vh]">
        <div className="px-6 sm:px-10 md:px-20 py-20">
          ...
          <Typography className="text-base leading-relaxed">
            Ini adalah section baru dengan background putih. Kamu bisa tambahkan
            content apa saja di sini. Wave di atas menutupi batas antara
            background gelap (section 1) dan putih (section 2).
          </Typography>
        </div>
      </section>
    </main>
